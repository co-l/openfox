...
export const SETTINGS_DEFAULTS: Record<string, string> = {
  ...
  [SETTINGS_KEYS.DISPLAY_MAX_VISIBLE_ITEMS]: '100',
  ...
  [SETTINGS_KEYS.DISPLAY_DANGER_LEVEL_DISPLAY_MODE]: 'default',
  [SETTINGS_KEYS.DISPLAY_DANGER_LEVEL_AUTO_LIST]: 'false',
  [SETTINGS_KEYS.DISPLAY_DANGER_LEVEL_AUTO_LIST_THRESHOLD]: '3',
