...
export const SETTINGS_DEFAULTS: Record<string, string> = {
  ...
  [SETTINGS_KEYS.DISPLAY_SHOW_MODEL_PRICES]: 'false',
  [SETTINGS_KEYS.DISPLAY_SHOW_MODEL_PRICE_INPUT]: 'true',
  [SETTINGS_KEYS.DISPLAY_SHOW_MODEL_PRICE_OUTPUT]: 'true',
  [SETTINGS_KEYS.DISPLAY_SHOW_MODEL_PRICE_CACHE_READ]: 'true',
  [SETTINGS_KEYS.DISPLAY_SHOW_MODEL_PRICE_CACHE_WRITE]: 'true',
  [SETTINGS_KEYS.DISPLAY_SHOW_MODEL_PRICE_POPOVER]: 'true',
  [SETTINGS_KEYS.DISPLAY_ENABLE_MODEL_PRICE_COLORS]: 'true',
  [SETTINGS_KEYS.DISPLAY_COLOR_MODEL_NAME_BY_OUTPUT_PRICE]: 'false',
  [SETTINGS_KEYS.DISPLAY_SHOW_MODEL_PRICE_IN_BAR]: 'false',
  [SETTINGS_KEYS.DISPLAY_SHOW_MODEL_PRICE_IN_BAR_INPUT]: 'true',
  [SETTINGS_KEYS.DISPLAY_SHOW_MODEL_PRICE_IN_BAR_OUTPUT]: 'true',
  [SETTINGS_KEYS.DISPLAY_SHOW_MODEL_PRICE_IN_BAR_CACHE_READ]: 'true',
