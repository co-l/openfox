...
export { detectModel, getCachedModel, clearModelCache, getModelInfo, getLlmStatus, setLlmStatus, type LlmStatus, type LlmModel } from './models.js'
...
export { detectBackend, getBackendCapabilities, getBackendDisplayName, type Backend, type BackendCapabilities } from './backend.js'
export type {
  LLMClient,
  LLMMessage,
  LLMToolDefinition,
