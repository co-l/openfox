import { select, text, spinner, log, outro, intro } from '@clack/prompts'
...
const LLM_OPTIONS = [
  ...
  { value: 'http://localhost:11434', label: 'Ollama' },
  { value: 'http://localhost:8080', label: 'SGLang/llama.cpp' },
