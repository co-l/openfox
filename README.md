...
To authenticate with a Github copilot account, you can install the [`openfox-github-copilot`]([https://github.com/arthurlacoste/openfox-chatgpt](https://github.com/JamesDAdams/openfox-github-copilot)) plugin.
