  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto space-y-1">
        {criteria.length === 0 ? (
          <div className="text-text-muted text-sm text-center py-2">No criteria yet</div>
        ) : (
          criteria.map((criterion, index) => (
            <div key={criterion.id} className="bg-bg-tertiary rounded p-2 border border-border">
