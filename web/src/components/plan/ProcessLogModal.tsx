    ...
    >
      ...
      >
        <div className="flex items-center justify-between p-3 border-b border-border">
          <h3 className="text-sm font-semibold text-text-primary truncate">{processName}</h3>
          <button
            onClick={onClose}
        ...
        <pre
          ref={logRef}
          className="flex-1 overflow-auto p-4 text-sm font-mono text-text-primary whitespace-pre-wrap"
        >
          {logs.length === 0 ? (
